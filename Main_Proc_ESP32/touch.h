...
/* uncomment for GT911 */
#define TOUCH_GT911
#define TOUCH_GT911_SCL 38
#define TOUCH_GT911_SDA 39
#define TOUCH_GT911_INT 5
...
#if defined(TOUCH_SWAP_XY)
    touch_last_x = map(ts.points[0].y, TOUCH_MAP_Y1, TOUCH_MAP_Y2, 0, gfx->width() - 1);
    touch_last_y = map(ts.points[0].x, TOUCH_MAP_X2, TOUCH_MAP_X1, gfx->height() - 1, 0);
#else
