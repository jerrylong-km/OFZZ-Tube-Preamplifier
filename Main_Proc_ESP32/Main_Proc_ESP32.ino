...
static const byte LEFT_MUSES_ADDRESS =  0;//A0和A1两个条线都开路
static const byte RIGHT_MUSES_ADDRESS = 1;//A0条线开路，A1条线短接
...
/*      
      //测试是否接收到Arduino串口发过来的信息
      if(FrontPad_Input != 23)
      {
        char SerialText[16];
        itoa(FrontPad_Input, SerialText, 10);
        lv_label_set_text(ui_Input, SerialText);
        delay(1000);
      }
*/      
